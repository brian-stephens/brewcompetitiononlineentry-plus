...
if ((!empty($assigned_score)) && (count($assigned_score) > 1)) {
	$notes .= "<div style=\"margin-bottom:5px;\" class=\"text-success\">".$label_assigned_score.": ".$assigned_score[0]."</div>";
}
...
elseif ($scored_by_user) {
	...
	if ($table_judging_open) {
		...
		if (!$disable_add_edit) {
    		$actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" class=\"btn btn-sm btn-warning\" href=\"".$edit_link."\">".$label_edit;
    		$actions .= "</a>";
    	}
	...
	if ($table_judging_open) { 
		...
		if ($disable_add_edit) {
			...
			if (TESTING) {
				...
				$actions .= "<div class=\"row\" style=\"margin-top: 3px;\">";
				$actions .= "<div style=\"padding-top:3px;\" class=\"col col-md-6 col-sm-12\">";
				$actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" class=\"btn btn-block btn-xs btn-info\" href=\"".$add_link_full."\">Classic</a>";
				$actions .= "</div>";
				
				if ($row_style['brewStyleType'] <= 3) {
					$actions .= "<div style=\"padding-top:3px;\" class=\"col col-md-6 col-sm-12\">";
					$actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" class=\"btn btn-block btn-xs btn-info\" href=\"".$add_link_structured."\">Structured</a>";
					$actions .= "</div>";
				}
				...
				if (($row_style['brewStyleType'] == 1) || ($row_style['brewStyleType'] == 2)) {
					...
					if ($row_style['brewStyleType'] == 1) {
						$actions .= "<div style=\"padding-top:3px;\" class=\"col col-md-6 col-sm-12\">";
						$actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" class=\"btn btn-block btn-xs btn-info\" href=\"".$add_link_checklist."\">Checklist</a>";
						$actions .= "</div>";
					}

					if ($row_style['brewStyleType'] == 2) {
						$actions .= "<div style=\"padding-top:3px;\" class=\"col col-md-6 col-sm-12\">";
						$actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" class=\"btn btn-block btn-xs btn-info\" href=\"".$add_link_nw_cider."\">NW Cider</a>";
						$actions .= "</div>";
					}
			...
			else $actions .= "<a onclick=\"bcoemClearScoresheetDraftStorage();\" style=\"margin-bottom:5px;\" class=\"btn btn-block btn-sm btn-primary\" href=\"".$add_link."\">".$label_add."</a>";
