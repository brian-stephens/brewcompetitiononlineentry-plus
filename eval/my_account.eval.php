...
if (((in_array($label_judge,$assignment_array)) && ($_SESSION['brewerJudge'] == "Y")) && ((time() >= $row_judging_prefs['jPrefsJudgingOpen']) || (judge_has_open_hidden_session($_SESSION['user_id'])))) {
