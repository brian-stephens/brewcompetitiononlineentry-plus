...
// Fallback in case a translation file doesn't have this string yet.
...
if ($entry_found) {
  ...
  $entry_info_html .= "<form class=\"hide-loader-form-submit form-horizontal\" name=\"form1\" data-toggle=\"validator\" role=\"form\" action=\"".$base_url."index.php?section=admin&amp;go=evaluation&amp;action=add\" method=\"post\">";
...
<?php if (($action == "edit") && (isset($row_eval['evalFinalScore'])) && ($row_eval['evalFinalScore'] !== NULL) && ($row_eval['evalFinalScore'] !== "")) { ?>
<div class="form-group">
  <label><?php echo $label_assigned_score; ?></label>
  <p class="form-control-static"><?php echo $row_eval['evalFinalScore']; ?></p>
  <div class="help-block small"><?php echo $evaluation_info_138; ?></div>
</div>
<?php } ?>
<!-- Scoring Guide -->
