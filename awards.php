...
if (($display_to_admin) || ($display_to_public)) {
	...
	/**
	 * Build unique DOM ids for awards place fragments.
	 * Honorable Mentions (place 5) can appear more than once per slide.
	 * Legacy place 4 values are treated as HM as well.
	 */
	function awards_place_ids($score_place, $eid) {
		$place_heirarchy = place_heirarchy($score_place);
		$suffix = "";
		$hm_class = "";
		$hm_class_name = "";
		$hm_class_club = "";
		$hm_class_style = "";
		if (in_array((string)$score_place, array("4", "5"), true)) {
			$suffix = "-e".preg_replace('/[^0-9A-Za-z_-]/', '', (string)$eid);
			$hm_class = " pos-hm";
			$hm_class_name = " pos-hm-name";
			$hm_class_club = " pos-hm-club";
			$hm_class_style = " pos-hm-style";
		}
		return array(
			"hierarchy" => $place_heirarchy,
			"pos" => "pos-".$place_heirarchy.$suffix,
			"name" => "pos-".$place_heirarchy.$suffix."-name",
			"club" => "pos-".$place_heirarchy.$suffix."-club",
			"style" => "pos-".$place_heirarchy.$suffix."-style",
			"hm_class" => $hm_class,
			"hm_class_name" => $hm_class_name,
			"hm_class_club" => $hm_class_club,
			"hm_class_style" => $hm_class_style
		);
	}
				...
				do {
					...
					if ($totalRows_scores > 0) {
						...
						do {
							...
							$place_ids = awards_place_ids($row_scores['scorePlace'], $row_scores['eid']);
							$place_heirarchy = $place_ids['hierarchy'];
							...
							$slides_tables .= "<div class=\"fragment justify-right col-right".$place_ids['hm_class']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['pos']."\"><i class=\"fa fa-trophy icon pos-".$place_heirarchy."-medal-color\"></i>".$display_place."</div>";
							$slides_tables .= "<div class=\"fragment justify-left".$place_ids['hm_class_name']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['name']."\">";
							...
							$slides_tables .= "</div>";
							if ($_SESSION['prefsProEdition'] == 0) $slides_tables .= "<div class=\"fragment justify-left small".$place_ids['hm_class_club']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['club']."\">".truncate_string($brewer_club,25," ")."</div>";
							$slides_tables .= "<div class=\"fragment justify-left small entry-name bottom-row".$place_ids['hm_class_style']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['style']."\">".truncate_string($entry_name,65," ")." (".$style_display.")</div>";
							$slides_tables .= "</div>";
					...
					if ($row_score_count['count'] > 0) {
						...
						if ($totalRows_scores > 0) {
							...
							do {
								...
								$slides .= "<div class=\"fragment justify-right col-right".$place_ids['hm_class']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['pos']."\"><i class=\"fa fa-trophy icon pos-".$place_heirarchy."-medal-color\"></i>".$display_place."</div>";
								$slides .= "<div class=\"fragment justify-left".$place_ids['hm_class_name']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['name']."\">";
								$slides .= $brewer_name;
								...
								if ($_SESSION['prefsProEdition'] == 0) $slides .= "<div class=\"fragment justify-left small".$place_ids['hm_class_club']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['club']."\">".truncate_string($brewer_club,25," ")."</div>";
								$slides .= "<div class=\"fragment justify-left small entry-name bottom-row".$place_ids['hm_class_style']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['style']."\">".truncate_string($entry_name,65," ")." (".$style_display.")</div>";
								$slides .= "</div>";
	...
	foreach ($st as $type) {
		...
		if ($totalRows_bos > 0) {
			...
			do {
				...
				$place_ids = awards_place_ids($row_bos['scorePlace'], $row_bos['eid']);
				$place_heirarchy = $place_ids['hierarchy'];
				...
				$slides_bos .= "<div class=\"fragment justify-right col-right".$place_ids['hm_class']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['pos']."\"><i class=\"fa fa-trophy icon pos-".$place_heirarchy."-medal-color\"></i>".$display_place."</div>";
				$slides_bos .= "<div class=\"fragment justify-left".$place_ids['hm_class_name']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['name']."\">";
				...
				if ($_SESSION['prefsProEdition'] == 0) $slides_bos .= "<div class=\"fragment justify-left small".$place_ids['hm_class_club']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['club']."\">".truncate_string($brewer_club,25," ")."</div>";
				$slides_bos .= "<div class=\"fragment justify-left small entry-name bottom-row".$place_ids['hm_class_style']."\" data-fragment-index=\"".$place_heirarchy."\" id=\"".$place_ids['style']."\">".truncate_string($entry_name,65," ")." (".$style_display.")</div>";
				$slides_bos .= "</div>"; 
