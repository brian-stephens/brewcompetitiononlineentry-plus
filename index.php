...
if ((!$logged_in) && (in_array($section,$account_pages))) {
    ...
    if (($section == "evaluation") && ($go == "scoresheet")) {
        if (($action == "edit") && (is_numeric($id)) && ((int) $id > 0)) $redirect .= "&return_eval_id=".$id;
        elseif (($action == "add") && (is_numeric($id)) && ((int) $id > 0)) $redirect .= "&return_eid=".$id;
    }
...
if ($section == "admin") {
    ...
    // dropoff / contacts / stewarding DB includes are loaded by the screens that need them
}
