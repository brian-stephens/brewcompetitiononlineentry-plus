...
switch($section) {
	...
	case "evaluation":
		...
		switch($go) {
			...
			break;
			case "reconcile":
				$header_output = (isset($label_reconcile_scores)) ? $label_reconcile_scores : "Reconcile Scores";
			break;
		}
	break;
	...
	case "register":
		...
		elseif ($msg == "7") $output = sprintf("<strong>%s</strong> %s",$header_text_125, $header_text_008);
		else $output = "";
	break;
	...
	case "list":
		...
		elseif ($msg == "17") $output = sprintf("<strong>%s</strong>",$header_text_117);
		elseif ($msg == "18") $output = sprintf("<strong>%s</strong>",$header_text_118);
		elseif ($msg == "19") $output = sprintf("<strong>%s</strong>",$header_text_119);
		elseif ($msg == "20") $output = sprintf("<strong>%s</strong>",$header_text_120);
		elseif ($msg == "21") $output = sprintf("<strong>%s</strong>",$header_text_121);
		elseif ($msg == "22") $output = sprintf("<strong>%s</strong>",$header_text_122);
		else $output = "";
	break;
	...
	case "admin":
		if ($action != "print") $header_output = $label_admin;
			...
			switch($go) {
				...
				case "judging_analytics":
				$header_output .= ": ".$label_admin_judging_analytics;
				break;
				...
				case "coupons":
				$header_output .= ": ".$label_admin_coupons;
				break;
				...
				elseif  ($action == "overview")  $header_output .= ": ".(isset($label_eval_overview) ? $label_eval_overview : "Evaluation Progress");
				elseif  ($action == "entrant_tracker")  $header_output .= ": ".(isset($label_eval_tracker) ? $label_eval_tracker : "Entrant Placement Tracker");
				elseif  ($action == "judge_view")  $header_output .= ": ".(isset($label_eval_judge_view) ? $label_eval_judge_view : "Judge Evaluations");
		...
		elseif ($msg == "38") $output = sprintf("<strong>%s</strong> Imported %s. Skipped %s.",$header_text_123, intval($inserted), intval($sort));
		elseif ($msg == "39") $output = sprintf("<strong>%s</strong>",$header_text_124);
