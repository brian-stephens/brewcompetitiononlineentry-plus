...
if ((isset($_SERVER['HTTP_REFERER'])) && (((isset($_SESSION['loginUsername'])) && ((isset($_SESSION['userLevel'])) && ($_SESSION['userLevel'] == 0))) || ($section == "setup"))) {
	...
	$judgingLocHidden = "0";
	if ((isset($_POST['judgingLocHidden'])) && ($_POST['judgingLocHidden'] == "1")) $judgingLocHidden = "1";

	$judgingLocComplete = "0";
	if ((isset($_POST['judgingLocComplete'])) && ($_POST['judgingLocComplete'] == "1")) $judgingLocComplete = "1";
	...
	$data = array(
		...
		'judgingLocHidden' => $judgingLocHidden
	);
	if (check_update("judgingLocComplete", $prefix."judging_locations")) $data['judgingLocComplete'] = $judgingLocComplete;
