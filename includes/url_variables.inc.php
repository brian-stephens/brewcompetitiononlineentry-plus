...
$inserted = "default";
$admin = "default";
$judging_session_filter = "default";
$return_eid = "default";
$return_eval_id = "default";
...
if (isset($_GET['session'])) $judging_session_filter = sterilize($_GET['session']);
if (isset($_GET['return_eid'])) $return_eid = sterilize($_GET['return_eid']);
if (isset($_GET['return_eval_id'])) $return_eval_id = sterilize($_GET['return_eval_id']);
?>