...
$link_list = build_public_url("list","default","default","default",$sef,$base_url);
        ...
        <ul class="nav navmenu-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Entries<?php if ($_SESSION['prefsPaypalIPN'] == 1) echo ", Payments,";?> and Participants <span class="caret"></span></a>
                <ul class="dropdown-menu navmenu-nav">
                    ...
                    <li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=coupons">Manage Vouchers</a></li>
                    <?php } ?>
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Scoring <span class="caret"></span></a>
                ...
                <?php if ($_SESSION['userAdminObfuscate'] == 0) { ?>
                	...
                	<li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=evaluation&amp;action=overview&amp;view=admin">Evaluation Progress</a></li>
                	<li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=evaluation&amp;action=entrant_tracker&amp;view=admin"><?php echo (isset($label_eval_tracker)) ? $label_eval_tracker : "Entrant Placement Tracker"; ?></a></li>
                	<li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=evaluation&amp;action=judge_view&amp;view=admin"><?php echo (isset($label_eval_judge_view)) ? $label_eval_judge_view : "Judge Evaluations"; ?></a></li>
                	<?php } ?>
                	<li><a href="<?php echo $base_url; ?>index.php?section=evaluation&amp;go=default&amp;filter=default&amp;view=admin">Manage Entry Evaluations</a></li>
                	<?php } ?>
                    ...
                    <li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=judging_analytics">Judge Analytics</a></li>
                    <?php } ?>
                <?php } ?>
                </ul>
            </li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" data-toggle="validator" role="form" action="<?php echo $base_url; ?>includes/process.inc.php?section=login&action=login" method="POST" name="form1" id="form1">
					<?php if ((isset($return_eid)) && (is_numeric($return_eid)) && ((int)$return_eid > 0)) { ?>
					<input type="hidden" name="return_eid" value="<?php echo (int)$return_eid; ?>">
					<?php } ?>
					<?php if ((isset($return_eval_id)) && (is_numeric($return_eval_id)) && ((int)$return_eval_id > 0)) { ?>
					<input type="hidden" name="return_eval_id" value="<?php echo (int)$return_eval_id; ?>">
					<?php } ?>
      ...
      <div class="<?php echo $container_main; ?>">
        ...
        <div class="collapse navbar-collapse" id="bcoem-navbar-collapse">
          <ul class="nav navbar-nav">
            <li<?php if ($section == "default") echo $active_class; ?>><a class="hide-loader" href="<?php echo $base_url; ?>"><i class="fa fa-home"></i></a></li>
            <?php if ($go != "default") { ?><li><a class="hide-loader" href="<?php echo $base_url."index.php?section=admin;" ?>"><i class="fa fa-tachometer-alt"></i></a></li><?php } ?>
          </ul>
