...
<div class="mb-3">
	<div class="row">
    	...
    	<div class="col-12 col-sm-12 col-md-9">
	        <input type="number" class="form-control score-choose" name="evalAromaScore" id="evalAromaScore" min="1" max="<?php echo $aroma_points; ?>" step="1" placeholder="" value="<?php if (($action == "edit") && (isset($row_eval['evalAromaScore']))) echo $row_eval['evalAromaScore']; ?>" required>
...
<div class="mb-3 row">
	...
	<div class="col-12 col-sm-12 col-md-9">
    <input type="number" class="form-control score-choose" name="evalAppearanceScore" id="evalAppearanceScore" min="1" max="<?php echo $appearance_points; ?>" step="1" placeholder="" value="<?php if (($action == "edit") && (isset($row_eval['evalAppearanceScore']))) echo $row_eval['evalAppearanceScore']; ?>" required>
    <div class="help-block small invalid-feedback"></div>
	</div>
</div>
...
<div class="mb-3">
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-md-9">
			<input type="number" class="form-control score-choose" name="evalFlavorScore" id="evalFlavorScore" min="1" max="<?php echo $flavor_points; ?>" step="1" placeholder="" value="<?php if (($action == "edit") && (isset($row_eval['evalFlavorScore']))) echo $row_eval['evalFlavorScore']; ?>" required>
	    	<div class="help-block small invalid-feedback"></div>
		</div>
	</div> 
</div>
...
<div class="mb-3">
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-md-9">
			<input type="number" class="form-control score-choose" name="evalMouthfeelScore" id="evalMouthfeelScore" min="1" max="<?php echo $mouthfeel_points; ?>" step="1" placeholder="" value="<?php if (($action == "edit") && (isset($row_eval['evalMouthfeelScore']))) echo $row_eval['evalMouthfeelScore']; ?>" required>
		    <div class="help-block small invalid-feedback"></div>
		</div>
	</div>
</div>
...
<div class="mb-3 row">
	...
	<div class="col-12 col-sm-12 col-md-9">
		<input type="number" class="form-control score-choose" name="evalOverallScore" id="evalOverallScore" min="1" max="<?php echo $overall_points; ?>" step="1" placeholder="" value="<?php if (($action == "edit") && (isset($row_eval['evalOverallScore']))) echo $row_eval['evalOverallScore']; ?>" required>
	    <div class="help-block small invalid-feedback"></div>
	</div>
</div>
