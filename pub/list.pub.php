...
if (($show_entries) && (!$show_scores) && (session_pref_enabled('prefsCoupons', 1))) $user_edit_links .= sprintf("<a class=\"btn btn-primary\" href=\"#coupons\"><i class=\"fa fa-ticket me-2\"></i>%s</a>",$label_coupons);
...
if ((isset($assignment_array) && ((in_array($label_judge,$assignment_array)) && ($_SESSION['brewerJudge'] == "Y")) && ((time() >= $row_judging_prefs['jPrefsJudgingOpen']) || (judge_has_open_hidden_session($_SESSION['user_id']))))) {
...
<?php if (($show_entries) && (!$show_scores) && (session_pref_enabled('prefsCoupons', 1))) include (PUB.'coupons.pub.php'); ?>
<?php 
