...
<section id="participant-clubs">
    ...
    <div id="brewerClubsOther" class="mb-3 row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10">
            <input class="form-control" name="brewerClubsOther" type="text" value="<?php if (($action == "edit") && ($club_other)) echo htmlspecialchars(html_entity_decode($row_brewer['brewerClubs']), ENT_QUOTES, 'UTF-8'); ?>" placeholder="" pattern="[^%&\x22\x27]+">
