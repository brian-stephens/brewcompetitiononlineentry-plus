...
$extra_acks = get_contest_extra_acks();
foreach ($extra_acks as $extra_ack) {
    $extra_ack_title = (!empty($extra_ack['title'])) ? $extra_ack['title'] : $register_text_053;
    $extra_ack_text = (!empty($extra_ack['text'])) ? $extra_ack['text'] : $register_text_054;
    $warning_extra_acks .= sprintf("<div class=\"alert alert-warning\"><strong>%s:</strong> %s</div>", htmlspecialchars($extra_ack_title, ENT_QUOTES, 'UTF-8'), htmlspecialchars($extra_ack_text, ENT_QUOTES, 'UTF-8'));
}
...
if ((isset($_COOKIE['userQuestion'])) && ($_COOKIE['userQuestion'] != "Randomly generated.")) {
	...
	$security .= "<input class=\"form-check-input\" type=\"radio\" name=\"userQuestion\" value=\"". htmlspecialchars($_COOKIE['userQuestion'], ENT_QUOTES, 'UTF-8') ."\" CHECKED>";
	$security .= "<label class=\"form-check-label\">". htmlspecialchars($_COOKIE['userQuestion'], ENT_QUOTES, 'UTF-8') ."</label>";
	$security .= "</div>";
}
...
if ((isset($row_judging3)) && (!empty($row_judging3))) {
	...
	do { 
        ...
        if ($row_judging3['judgingLocType'] == 2) {
            ...
            if ((((time() < $row_judging3['judgingDate']) && ($row_judging3['judgingLocHidden'] != "1")) || (($go == "admin") && ($filter != "default"))) && (!empty($staff_avail_info) && (!empty($staff_avail_option)))) {
...
<!-- Begin the Form -->
	...
	<div class="mb-3 row">
	    ...
	    <div class="col-xs-12 col-sm-9 col-lg-10">
	        <input class="form-control" name="userQuestionAnswer" id="userQuestionAnswer" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['userQuestionAnswer']))) echo htmlspecialchars($_COOKIE['userQuestionAnswer'], ENT_QUOTES, 'UTF-8'); ?>" required>
	...
	<div class="mb-3 row">
	    ...
	    <div class="col-xs-12 col-sm-9 col-lg-10">
	        <input class="form-control" name="brewerFirstName" id="brewerFirstName" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerFirstName']))) echo htmlspecialchars($_COOKIE['brewerFirstName'], ENT_QUOTES, 'UTF-8'); ?>" required>
	...
	<div class="mb-3 row">
	    ...
	    <div class="col-xs-12 col-sm-9 col-lg-10">
	        <input class="form-control" name="brewerLastName" id="brewerLastName" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerFirstName']))) echo htmlspecialchars($_COOKIE['brewerLastName'], ENT_QUOTES, 'UTF-8'); ?>" data-error="" required>
	...
	<section id="address-fields">
	    ...
	    <div class="mb-3 row">
	        ...
	        <div class="col-xs-12 col-sm-9 col-lg-10">
	            <input class="form-control" name="brewerAddress" id="brewerAddress" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerAddress']))) echo htmlspecialchars($_COOKIE['brewerAddress'], ENT_QUOTES, 'UTF-8'); ?>" required>
		...
		<div class="mb-3 row">
		    ...
		    <div class="col-xs-12 col-sm-9 col-lg-10">
		        <input class="form-control" name="brewerCity" id="brewerCity" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerCity']))) echo htmlspecialchars($_COOKIE['brewerCity'], ENT_QUOTES, 'UTF-8'); ?>" required>
		...
		<div class="mb-3 row">
			...
			<div class="col-xs-12 col-sm-9 col-lg-10">
				<div id="non-us-state">
				    <input class="form-control" name="brewerStateNon" id="brewerStateNon" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerState']))) echo htmlspecialchars($_COOKIE['brewerState'], ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo $label_select_state; ?>" required>
		...
		<div class="mb-3 row">
		    ...
		    <div class="col-xs-12 col-sm-9 col-lg-10">
		            <input class="form-control" name="brewerZip" id="brewerZip" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerZip']))) echo htmlspecialchars($_COOKIE['brewerZip'], ENT_QUOTES, 'UTF-8'); ?>" required>
	...
	<div class="mb-3 row">
	    ...
	    <div class="col-xs-12 col-sm-9 col-lg-10">
	        <input class="form-control" name="brewerPhone1" id="brewerPhone1" type="tel" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerPhone1']))) echo htmlspecialchars($_COOKIE['brewerPhone1'], ENT_QUOTES, 'UTF-8'); ?>" required>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="brewerJudgeRank[]" value="BJCP Certified Mead and/or Cider Only">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="brewerJudgeRank[]" value="Distinguished Certified">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="brewerJudgeRank[]" value="Distinguished National">
    ...
    <?php if (($section != "admin") && (!empty($extra_acks))) { ?>
    <!-- Extra Acknowledgments -->
    <section id="extra-acknowledgments">
        <?php foreach ($extra_acks as $extra_ack_i => $extra_ack) {
            $extra_ack_label = (!empty($extra_ack['title'])) ? $extra_ack['title'] : $label_eligibility;
            $extra_ack_checkbox = (!empty($extra_ack['checkbox'])) ? $extra_ack['checkbox'] : $register_text_055;
        ?>
        <div class="mb-3 row">
            <label for="brewerExtraAck<?php echo $extra_ack_i; ?>" class="col-xs-12 col-sm-3 col-lg-2 col-form-label text-teal"><i class="fa fa-star me-1"></i><strong><?php echo htmlspecialchars($extra_ack_label, ENT_QUOTES, 'UTF-8'); ?></strong></label>
            <div class="col-xs-12 col-sm-9 col-lg-10">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="brewerExtraAck[<?php echo $extra_ack_i; ?>]" value="Y" id="brewerExtraAck<?php echo $extra_ack_i; ?>" required />
                    <label class="form-check-label" for="brewerExtraAck<?php echo $extra_ack_i; ?>"><?php echo htmlspecialchars($extra_ack_checkbox, ENT_QUOTES, 'UTF-8'); ?></label>
                </div>
                <div class="help-block invalid-feedback text-danger"><?php echo $register_text_056; ?></div>
            </div>
        </div>
        <?php } ?>
    </section>
