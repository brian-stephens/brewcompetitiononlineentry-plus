...
$label_coupon = "Voucher";
$label_coupons = "Vouchers";
$label_coupon_code = "Voucher Code";
$label_coupon_credits = "Voucher Credits";
$label_redeem_coupon = "Redeem Voucher";
$label_apply_coupon = "Apply Voucher";
...
$header_text_117 = "Voucher code redeemed successfully.";
$header_text_118 = "That voucher code is invalid, inactive, expired, or out of redemptions.";
$header_text_119 = "That voucher code has already been redeemed by your account.";
$header_text_120 = "Voucher applied. The entry is now marked as paid.";
$header_text_121 = "No voucher credits are available for your account.";
$header_text_122 = "Unable to apply voucher to that entry.";
$header_text_123 = "Voucher import complete.";
$header_text_124 = "Voucher import failed. Please upload a valid CSV file.";
...
$alert_text_085 = "You will not be able to print any entry's bottle labels until payment for it has been confirmed and the entry has been marked as &quot;paid&quot; below. Select the checkbox for each paid entry and then select the &quot;Print Selected Entry Labels&quot; button. This will open a new tab or window with your entry labels, ready to print.";
...
$evaluation_info_053 = "The consensus score is the final score agreed upon by all judges evaluating the entry. Enter the score you and your fellow judge(s) have agreed on. If it differs from what other judges enter, you will be notified.";
...
$evaluation_info_119 = "Your scoresheet has been submitted. Once another judge assigned to this entry finishes their evaluation, you'll be able to agree on a final consensus score together.";
$evaluation_info_120 = "This page checks automatically for the other judge's score. You may also leave this page and come back later from the Judging Dashboard.";
$evaluation_info_121 = "Discuss with your fellow judge(s) and enter the consensus score you have agreed on below. This is not a new personal score - it is the final score everyone judging this entry agrees to. Each judge enters that same agreed score; once everyone's entries match, consensus is reached.";
$evaluation_info_123 = "Consensus score set.";
$evaluation_info_124 = "Saving draft...";
$evaluation_info_125 = "Draft saved at";
$evaluation_info_126 = "Draft save failed. Keep working and submit when ready.";
$evaluation_info_127 = "%s just submitted a consensus score of %s.";
$evaluation_info_128 = "Sync checks every few seconds.";
$evaluation_info_129 = "Consensus scores don't match yet - discuss with your fellow judge(s) and update the agreed score below until everyone has entered the same value.";
$evaluation_info_130 = "%d of %d judges have submitted a consensus score.";

$label_waiting_for_partner = "Waiting for Other Judge(s)";
$label_reconcile_scores = "Reconcile Scores";
$label_view_consensus = "View Consensus";
$label_consensus_set = "Consensus Reached";
$label_scores_dont_match = "Scores Don't Match Yet";
$label_not_submitted = "Not yet submitted";
$label_your_consensus_score = "Your Consensus Score";
...
/**
 * ------------------------------------------
 * Admin: Set Consensus, Scoped Import,
 * Session Filter (Manage Entry Evaluations)
 * ------------------------------------------
 */

$label_set_consensus = "Set Consensus";
$label_save_consensus = "Save Consensus Score";
$label_import_this_table = "Import This Table";
$label_session_filter = "Judging Session";
$label_all_sessions = "All Sessions";

$evaluation_info_131 = "Use this to set or correct the agreed consensus score for this entry across all judges. This does not import the score - use Import Score Data afterward.";
$evaluation_info_132 = "Please enter a score between 5 and 50.";
$evaluation_info_133 = "Are you sure you want to set the consensus score for this entry? This will overwrite the consensus score on every judge's evaluation for this entry.";
$evaluation_info_134 = "Something went wrong saving the consensus score. Please try again.";
$evaluation_info_135 = "This will import scores for this table only.";
$evaluation_info_136 = "This will import scores for this judging session only.";
$evaluation_info_137 = "This will import scores for all tables and sessions.";
$evaluation_info_138 = "This is the average of every judge's score for this entry, calculated automatically - no action is needed from you. It updates as judges add or edit their evaluations.";
...
$label_eval_overview = "Evaluation Progress";
$label_eval_overview_in_progress = "In Progress";
$label_eval_overview_issues = "Issues";
$label_eval_overview_ready = "Ready to Import";
$label_eval_overview_imported = "Imported";
$label_eval_overview_no_issues = "No issues";
$label_eval_overview_manage_details = "Manage Entry Details";
$label_eval_overview_view_details = "View Details";
$label_eval_overview_update_now = "Update Now";
$label_eval_overview_updated = "Updated";
$label_eval_overview_select_session = "Select a session...";
$label_eval_overview_scores_imported = "scores already imported";
$label_eval_overview_dashboard = "Progress Overview";
$label_eval_tracker = "Entrant Placement Tracker";
$label_eval_tracker_search_label = "Find Entrants";
$label_eval_tracker_search_placeholder = "Type at least 2 letters to search entrants...";
$label_eval_tracker_update_now = "Update Now";
$label_eval_tracker_status_clear = "Clear";
$label_eval_tracker_status_pending = "Judging Incomplete";
$label_eval_tracker_status_has_place = "Placed";
$label_eval_tracker_status_bos_pull = "BoS Pull";
$label_eval_tracker_status_gold = "Gold Conflict";
$label_eval_tracker_source_official = "Official";
$label_eval_tracker_source_eval = "Pending Eval";
$label_eval_tracker_progress = "Progress";
$label_eval_tracker_progress_not_started = "Not started";
$label_eval_tracker_progress_in_progress = "In progress";
$label_eval_tracker_progress_awaiting_place = "Awaiting place";
$label_eval_tracker_progress_placed_pending = "Place pending import";
$label_eval_tracker_progress_complete_no_place = "Complete - no place";
$label_eval_tracker_progress_placed_official = "Complete - official place";
$label_eval_tracker_not_started = "Not started";
$label_eval_tracker_in_progress = "In progress";
$label_eval_tracker_awaiting_place = "Awaiting place";
$label_eval_tracker_no_place = "No place";
$label_evals = "Evals";
$label_consensus = "consensus";
$label_eval_judge_view = "Judge Evaluations";
$label_eval_judge_view_filter = "Judge";
$label_eval_judge_view_select = "Select a judge...";
$label_eval_judge_view_judge_score = "Judge Score";
$label_eval_judge_view_consensus = "Consensus";

$evaluation_info_139 = "Table status refreshes automatically every 30 seconds.";
$evaluation_info_140 = "Select a judging session to view table evaluation progress.";
$evaluation_info_141 = "No tables are assigned to this judging session.";
$evaluation_info_142 = "Import is available when the table is complete and has no issues.";
$evaluation_info_143 = "No judging sessions have been defined yet.";
$evaluation_info_144 = "Select entrants to track. Results update live while judging progresses.";
$evaluation_info_145 = "Search and add entrants to start tracking placements.";
$evaluation_info_146 = "No received entries found for this entrant.";
$evaluation_info_147 = "No electronic evaluations have been submitted yet.";
$evaluation_info_148 = "Select a judge to view their submitted evaluations.";
$evaluation_info_149 = "The selected judge was not found or has no electronic evaluations.";
