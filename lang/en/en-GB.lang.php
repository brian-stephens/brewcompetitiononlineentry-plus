...
$label_admin_judge_prefs = "Judging/Competition Organisation Preferences";
...
$header_text_026 = "Your online payment has been received and the transaction has been completed. Please note that you may need to wait a few minutes for the payment status to be updated here - be sure to refresh this page. You will receive a payment receipt via email from PayPal.";
$header_text_027 = "Please make sure to print the receipt and attach it to one of your entries as proof of payment.";
$header_text_028 = "Your online payment was cancelled.";
...
$alert_text_056 = "If you already registered an account, please log in.";
...
$brew_text_004 = "Specific type, special ingredients, classic style, strength (for beer styles), colour, and/or other information is required";
...
$brew_text_013 = "DO NOT use this field to specify special ingredients, classic style, strength (for beer entries), or colour.";
...
$brewer_text_004 = "Provide any information that you believe the competition organiser, judge coordinator, or competition staff should know (e.g., allergies, special dietary restrictions, shirt size, etc.).";
...
$brewer_text_018 = "By checking this box, I am effectively signing a legal document wherein I accept responsibility for my conduct, behavior and actions and completely absolve the competition and its organisers, individually or collectively, of responsibility for my conduct, behavior and actions.";
...
$brewer_text_021 = "Competition staff are people that serve in various roles to assist in the organisation and execution of the competition before, during, and after judging. Judges and stewards can also serve as staff members. Staff members can earn BJCP points if the competition is sanctioned.";
...
$default_page_text_023 = "organised by";
...
$reg_closed_text_006 = "received and processed entries (this number will update as entries are picked up from drop-off locations and organised for judging).";
...
$entry_info_text_040 = "Enclose <em>each</em> of your bottle labels in a small zip-top bag before attaching to their respective bottles. This way it makes it possible for the organiser to identify specifically which entry has broken if there is damage during shipment.";
...
$brewer_entries_text_004 = "You have entries that require you to define a specific type, special ingredients, classic style, strength, and/or colour.";
$brewer_entries_text_005 = "For each entry below with a <span class=\"fa fa-lg fa-exclamation-circle text-danger\"></span> icon, select the <span class=\"fa fa-lg fa-pencil text-primary\"></span> icon to enter the required information. Entries without a specific type, special ingredients, classic style, strength, and/or colour in categories that require them may be deleted by the system without warning.";
...
$pay_text_023 = "Enter the code supplied by the competition organisers for a discounted entry fee.";
...
if (strpos($view, "^") !== FALSE) $qr_text_005 = sprintf("Entry number %s was not found in the database. Set the bottle(s) aside and alert the competition organiser.",$qr_text_019); else $qr_text_005 = "";
...
$styles_entry_text_24C = "Entrant must specify blond, amber, or brown biere de garde. If no colour is specified, the judge should attempt to judge based on initial observation, expecting a malt flavour and balance that matches the colour.";
$styles_entry_text_25B = "The entrant must specify the strength (table, standard, super) and the colour (pale, dark).";
...
$output_text_004 = "Your scoresheets could not be properly generated. Please contact the organisers of the competition.";
...
$output_text_013 = "No participants provided notes to organisers.";
$output_text_014 = "The following are the notes to organisers entered by judges or stewards.";
$output_text_015 = "No participants provided notes to organisers.";
...
$alert_text_082 = "Since you signed up as a judge or steward, you are not allowed to add entries to your account. Only representatives of an organisation are able to add entries to their accounts.";
$alert_text_083 = "Adding and editing of entries is not available.";
$alert_text_084 = "As an Administrator, you can add an entry to an organisation's account by using the &quot;Add Entry For...&quot; dropdown menu on the Admin &gt; Entries and Participants &gt; Manage Entries page.";
$alert_text_085 = "You will not be able to print any entry's bottle labels until payment for it has been confirmed and the entry has been marked as &quot;paid&quot; below.";
...
$brew_text_029 = "Admin editing disabled. Your profile is considered a personal profile and not a organizational profile, and thus, not eligible to add entries. To add an entry for an organisation, access the Manage Entries list and choose an organisation from the &quot;Add an Entry For...&quot; dropdown.";
...
$brewer_text_032 = "Please provide your organisation name.";
...
$brewer_entries_text_018 = "You will not be able to print this entry's bottle labels until it has been marked as paid.";
...
$register_text_035 = "The information you provide beyond your organisation's name is strictly for record-keeping and contact purposes.";
$register_text_036 = "A condition of entry into the competition is providing this information, including a contact person's email address and phone number. Your organisation's name may be displayed should one of your entries place, but no other information will be made public.";
...
$register_text_044 = "Please provide an organisation name.";
...
$brewer_info_014 = "Access the Judging Dashboard using the button to enter evaluations of the entries assigned to you.";
...
$descr_alcoholic = "The aroma, flavour, and warming effect of ethanol and higher alcohols. Sometimes described as &quot;hot&quot;.";
$descr_alcoholic_mead = "The effect of ethanol. Warming. Hot.";
$label_metallic = "Metallic"; 
$descr_metallic = "Tinny, coiny, copper, iron, or blood-like flavour.";
...
$descr_oxidized_cider = "Staleness, the aroma/flavour of sherry, raisins, or bruised fruit.";
...
$descr_vegetal = "Cooked, canned, or rotten vegetable aroma and flavour (cabbage, onion, celery, asparagus, etc.).";
...
$descr_acetaldehyde = "Green apple-like aroma and flavour.";
$label_diacetyl = "Diacetyl";
$descr_diacetyl = "Artificial butter, butterscotch, or toffee aroma and flavour. Sometimes perceived as a slickness on the tongue.";
$descr_diacetyl_cider = "Butter or butterscotch aroma or flavour.";
$label_dms = "DMS (Dimethyl Sulfide)";
$descr_dms = "At low levels a sweet, cooked or canned corn-like aroma and flavour.";
$label_estery = "Estery";
$descr_estery = "Aroma and/or flavour of any ester (fruits, fruit flavorings, or roses).";
$label_grassy = "Grassy";
$descr_grassy = "Aroma/flavour of fresh-cut grass or green leaves.";
...
$descr_sour_acidic = "Tartness in aroma and flavour. Can be sharp and clean (lactic acid), or vinegar-like (acetic acid).";
$label_sulfur = "Sulfur";
$descr_sulfur = "The aroma of rotten eggs or burning matches.";
$label_sulfury = "Sulfury";
$label_yeasty = "Yeasty";
$descr_yeasty = "A bready, sulfury or yeast-like aroma or flavour.";
...
$label_acidic = "Acidic";
$descr_acidic = "Sour-tart flavour. Typically from one of several acids: malic, lactic, or citric. Must be in balance.";
$descr_acidic_mead = "Clean, sour flavour/aroma from low pH. Typically from one of several acids: malic, lactic, gluconic, or citric.";
$label_bitter = "Bitter";
...
$label_fruity = "Fruity";
$descr_fruity = "The aroma and flavour of fresh fruits that may be appropriate in some styles and not others.";
$descr_fruity_mead = "Flavour & aroma esters often derived from fruits in a melomel. Banana & pineapple are often off-flavors.";
$label_mousy = "Mousy";
...
$label_tannic = "Tannic";
$descr_tannic = "Drying, astringent puckering mouthfeel, similar to bitterness flavour. Taste of strong unsweetened tea or chewing on a grape skin.";
$label_waxy = "Waxy";
...
$evaluation_info_077 = "Comment on colour, clarity, and head (retention, colour, and texture).";
$evaluation_info_078 = "Comment on malt, hops, fermentation characteristics, balance, finish/aftertaste, and other flavour characteristics.";
...
if ((isset($_SESSION['prefsStyleSet'])) && (($_SESSION['prefsStyleSet'] == "BJCP2021") || ($_SESSION['prefsStyleSet'] == "BJCP2025"))) {
    ...
    $styles_entry_text_33B = "The entrant MUST specify the additional alcohol character, with information about the barrel if relevant to the finished flavour profile. If an unusual wood or ingredient has been used, the entrant MUST supply a brief description of the sensory aspects the ingredients add to the beer. Entrant MUST specify a description of the beer, identifying either a Base Style or the ingredients, specs, or target character of the beer. A general description of the special nature of the beer can cover all the required items.";
...
$evaluation_info_082 = "Comment on colour, clarity, legs, and carbonation.";
...
$evaluation_info_085 = "Colour (2), clarity (2), carbonation level (2).";
...
$label_industry_affiliations = "Industry Organisation Affiliations";
...
$evaluation_info_101 = "Please provide another colour descriptor.";
...
$brewer_text_052 = "<strong>If any industry organisation is <u>not</u> listed in the drop-down above, enter it here.</strong> Separate each organisation's name by comma (,) or semi-colon (;). Some symbols are not allowed, including double-quotation marks (&quot;) and percent (&#37;).";
...
$brewer_text_053 = "The Master Homebrewer Program is a nonprofit organisation established to promote the mastery of amateur brewing.";
...
$label_register_as_judge = "Register to be a Judge";
$label_register_as_steward = "Register to be a Steward";
...
$brew_text_059 = "Please provide the entry's colour.";
...
$styles_entry_text_C3A_2025 = "Entrants MUST specify both carbonation and sweetness levels. Entrants MUST specify all fruit or fruit juice added. Entrants MAY specify a base cider style. Entrants MAY specify the colour of added fruit.";
 ...
 * ------------------------------------------
 */
$label_eligibility = "Acknowledgment";
$register_text_053 = "Acknowledgment";
$register_text_054 = "Please read and acknowledge the following before registering.";
$register_text_055 = "I have read and agree to the above.";
$register_text_056 = "You must check the box to continue.";
$header_text_125 = "You must complete all required acknowledgments.";
