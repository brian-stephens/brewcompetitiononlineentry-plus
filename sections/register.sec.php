...
if (($_SESSION['prefsProEdition'] == 0) || (($_SESSION['prefsProEdition'] == 1) && ($go != "entrant"))) {
	...
	foreach ($_SESSION['club_array'] as $club) {
		$club_options .= "<option value=\"".htmlspecialchars($club, ENT_QUOTES, 'UTF-8')."\">".htmlspecialchars($club, ENT_QUOTES, 'UTF-8')."</option>\n";
	}
...
if ((isset($_COOKIE['userQuestion'])) && ($_COOKIE['userQuestion'] != "Randomly generated.")) $security .= "<div class=\"radio\"><label><input type=\"radio\" name=\"userQuestion\" value=\"". htmlspecialchars($_COOKIE['userQuestion'], ENT_QUOTES, 'UTF-8') ."\" CHECKED> ". htmlspecialchars($_COOKIE['userQuestion'], ENT_QUOTES, 'UTF-8') ."</label></div>";
...
if ((isset($row_judging3)) && (!empty($row_judging3))) {
    ...
    do { 
        ...
        if ($row_judging3['judgingLocType'] == 2) {
            ...
            if (((time() < $row_judging3['judgingDate']) && ($row_judging3['judgingLocHidden'] != "1")) || (($go == "admin") && ($filter != "default"))) {
	        ...
	        if ((time() < $row_judging3['judgingDate']) && ($row_judging3['judgingLocHidden'] != "1")) {
...
<!-- Begin the Form -->
    ...
    <div class="form-group"><!-- Form Group REQUIRED Text Input -->
        <label for="brewerBreweryName" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_name." (".$label_organization.")"; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="input-group has-warning">
                <span class="input-group-addon" id="brewerBreweryName-addon1"><span class="fa fa-beer"></span></span>
                <!-- Input Here -->
                <input class="form-control" id="brewerBreweryName" name="brewerBreweryName" type="text" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerBreweryName']))) echo htmlspecialchars($_COOKIE['brewerBreweryName'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_044; ?>" placeholder="" required autofocus>
            </div>
	...
	<div class="form-group"><!-- Form Group Text Input -->
        <label for="brewerBreweryTTB" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label"><?php echo $label_ttb." (".$label_organization.")"; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        	<!-- Input Here -->
       		<input class="form-control has-warning" id="brewerBreweryTTB" name="brewerBreweryTTB" type="text" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerBreweryTTB']))) echo htmlspecialchars($_COOKIE['brewerBreweryTTB'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
            <div class="help-block"><?php echo $register_text_046; ?></div>
        </div>
    </div><!-- ./Form Group -->
    <?php if ($_SESSION['prefsStyleSet'] == "NWCiderCup") { ?>
    <div class="form-group">
        <label for="brewerBreweryProd" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label"><?php echo $label_organization." ".$label_yearly_volume; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="radio">
                <label>
    ...
    <?php } else { ?>
    <div class="form-group">
        <label id="brewery-prod-label" for="brewerBreweryProd" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label"><i id="brewery-prod-label-icon" class="fa fa-fw fa-sm fa-star"></i> <?php echo $label_organization." ".$label_yearly_volume; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="radio">
                <label>
	...
	<!-- Email -->
    <div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo $label_contact." "; echo $label_email; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
    ...
    <div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_re_enter; if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo " ".$label_contact." "; echo " ".$label_email; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="re-enter-email-addon1"><span class="fa fa-envelope"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="user_name2" type="email" placeholder="" id="user_name2" data-match="#user_name" data-error="<?php echo $register_text_019; ?>"; data-match-error="<?php echo $register_text_020; ?>" value="<?php if (($msg != "default") && (isset($_COOKIE['user_name2']))) echo htmlspecialchars($_COOKIE['user_name2'], ENT_QUOTES, 'UTF-8'); ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
	</div><!-- ./Form Group -->
	...
	<!-- Password -->
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_password; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
	...
	<div class="form-group"><!-- Form Group REQUIRED Radio Group -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_security_question; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
                <?php echo $security; ?>
			</div>
	...
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_security_answer; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="security-question-answer-addon1"><span class="fa fa-bullhorn"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="userQuestionAnswer" id="userQuestionAnswer" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['userQuestionAnswer']))) echo htmlspecialchars($_COOKIE['userQuestionAnswer'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_023; ?>" required>
			</div>
	...
	<?php } // end if ($section != "admin") ?>
  	<!-- Name -->
    <div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo $label_contact." "; echo $label_first_name; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="first-name-addon1"><span class="fa fa-user"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerFirstName" id="brewerFirstName" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerFirstName']))) echo htmlspecialchars($_COOKIE['brewerFirstName'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_025; ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
	</div><!-- ./Form Group -->
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo $label_contact." "; echo $label_last_name; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="last-name-addon1"><span class="fa fa-user"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerLastName" id="brewerLastName" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerFirstName']))) echo htmlspecialchars($_COOKIE['brewerLastName'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_026; ?>" required>
			</div>
    ...
    <div class="form-group"><!-- Form Group REQUIRED Select -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_country; if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo " (".$label_organization.")"; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
		<!-- Input Here -->
	...
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_street_address; if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo " (".$label_organization.")"; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="street-addon1"><span class="fa fa-home"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerAddress" id="brewerAddress" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerAddress']))) echo htmlspecialchars($_COOKIE['brewerAddress'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_028; ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
    </div><!-- ./Form Group -->
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_city; if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo " (".$label_organization.")"; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="city-addon1"><span class="fa fa-home"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerCity" id="brewerCity" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerCity']))) echo htmlspecialchars($_COOKIE['brewerCity'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_029; ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
	</div><!-- ./Form Group -->
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_state_province; if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo " (".$label_organization.")"; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div id="non-us-state" class="input-group has-warning">
				...
				<!-- Input Here -->
				<input class="form-control" name="brewerStateNon" id="brewerStateNon" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerState']))) echo htmlspecialchars($_COOKIE['brewerState'], ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo $label_select_state; ?>" data-error="<?php echo $register_text_030; ?>" required>
			</div>
	...
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		...
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				...
				<!-- Input Here -->
				<input class="form-control" name="brewerZip" id="brewerZip" type="text" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerZip']))) echo htmlspecialchars($_COOKIE['brewerZip'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_031; ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
	</div><!-- ./Form Group -->
    ...
    <div class="form-group"><!-- Form Group REQUIRED Text Input -->
		...
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				...
				<!-- Input Here -->
				<input class="form-control" name="brewerPhone1" id="brewerPhone1" type="tel" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerPhone1']))) echo htmlspecialchars($_COOKIE['brewerPhone1'], ENT_QUOTES, 'UTF-8'); ?>" data-error="<?php echo $register_text_032; ?>" required>
			</div>
            <div class="help-block with-errors"></div>
		</div>
	</div><!-- ./Form Group -->
	<div class="form-group"><!-- Form Group Text Input -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label"><?php if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo $label_contact." "; echo $label_phone_secondary; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group">
				<span class="input-group-addon" id="phone2-addon1"><span class="fa fa-phone"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerPhone2" id="brewerPhone2" type="tel" placeholder="" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerPhone2']))) echo htmlspecialchars($_COOKIE['brewerPhone2'], ENT_QUOTES, 'UTF-8'); ?>">
			</div>
		</div>
	</div><!-- ./Form Group -->
    <?php if (($_SESSION['prefsProEdition'] == 0) || (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant"))) { ?>
	<div class="form-group"><!-- Form Group REQUIRED Select -->
		<label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_drop_off; ?></label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<!-- Input Here -->
...
<div id="proAm">
	...
	<div class="form-group"><!-- Form Group Text Input -->
		...
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group">
				...
				<!-- Input Here -->
				<input class="form-control" name="brewerAHA" id="brewerAHA" type="text" pattern="[A-Za-z0-9]+" placeholder="" data-error="<?php echo $brew_text_019; ?>" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerAHA']))) echo htmlspecialchars($_COOKIE['brewerAHA'], ENT_QUOTES, 'UTF-8'); ?>">
			</div>
			<div class="help-block with-errors"></div>
	...
	<section id="mhp-number">
	    <div class="form-group">
	        ...
	        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
	            <input class="form-control" name="brewerMHP" id="brewerMHP" type="text" pattern="\d*" placeholder="" data-error="<?php echo $brew_text_019; ?>" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerMHP']))) echo htmlspecialchars($_COOKIE['brewerMHP'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
    ...
    <div class="form-group"><!-- Form Group REQUIRED Radio Group -->
        <label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_judging; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    ...
    <div class="form-group"><!-- Form Group Text Input -->
        ...
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <!-- Input Here -->
            <input class="form-control" id="brewerJudgeID" name="brewerJudgeID" type="text" value="<?php if (($msg != "default") && (isset($_COOKIE['brewerJudgeID']))) echo htmlspecialchars($_COOKIE['brewerJudgeID'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
        </div>
    </div><!-- ./Form Group -->
    <div class="form-group"><!-- Form Group Radio STACKED -->
            <label for="brewerJudgeRank" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label"><?php if (($_SESSION['prefsProEdition'] == 1) && ($go == "entrant")) echo $label_contact." "; echo $label_bjcp_rank; ?></label>
            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
                <div class="input-group">
                    <!-- Input Here -->
                    <div class="radio">
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="brewerJudgeRank" value="BJCP Certified Mead and/or Cider Only"> BJCP Certified Mead and/or Cider Only
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="brewerJudgeRank" value="Distinguished Certified"> Distinguished Certified
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="brewerJudgeRank" value="Distinguished National"> Distinguished National
                        </label>
                    </div>
                    <div class="radio">
                        <label>
    ...
    <div class="form-group"><!-- Form Group REQUIRED Radio Group -->
        <label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_stewarding; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    ...
    <div class="form-group"><!-- Form Group REQUIRED Radio Group -->
        <label for="" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_stewarding_avail; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <p class="bcoem-form-info text-warning"><?php echo $register_text_052; ?></p>
    ...
    <!-- Show Waiver -->
    <div class="form-group"><!-- Form Group REQUIRED Radio Group -->
        <label for="brewerJudgeWaiver" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> <?php echo $label_waiver; ?></label>
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
            <div class="checkbox">
                <!-- Input Here -->
    ...
    <!-- CAPTCHA -->
	<div class="form-group">
		<label for="recaptcha" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label text-warning"><i class="fa fa-sm fa-star"></i> CAPTCHA</label>
		<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<!-- Input Here -->
