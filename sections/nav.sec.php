        ...
        <ul class="nav navmenu-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Scoring <span class="caret"></span></a>
                ...
                <?php if ($_SESSION['userAdminObfuscate'] == 0) { ?>
                	...
                	<?php } ?>
                	<li><a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=evaluation&amp;filter=default&amp;view=admin">Manage Entry Evaluations</a></li>
                	<?php } ?>
            ...
            <li id="user-menu-enable" class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php } if ($_SESSION['prefsEval'] == 1) { 
						...
						if (((in_array($label_judge,$assignment_array)) && ($_SESSION['brewerJudge'] == "Y")) && ((judging_winner_display($row_judging_prefs['jPrefsJudgingOpen'])) || (judge_has_open_hidden_session($_SESSION['user_id'])))) { 
                   	?>
