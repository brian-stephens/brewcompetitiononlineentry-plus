...
if ($registration_open < 2) {
	...
	if ($row_judging1) {
		do {
			if (($row_judging1['judgingLocType'] == 2) && ($row_judging1['judgingLocHidden'] != "1")) $staff_locations .= sprintf("<li>%s &ndash; %s</li>",$row_judging1['judgingLocName'],getTimeZoneDateTime($_SESSION['prefsTimeZone'], $row_judging1['judgingDate'], $_SESSION['prefsDateFormat'],  $_SESSION['prefsTimeFormat'], "long", "date-time"));
