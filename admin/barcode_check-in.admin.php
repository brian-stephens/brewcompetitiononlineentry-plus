...
if ($filter == "box-paid") {
    ...
    $switch_to_button = "Entry/Judging Numbers and Box";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You can check-in up to <?php echo $fields; ?> entries at a time. You can also record a shared box location for all entries on this screen.</p>
                    <ul>
                      <li>Enter the Box Number once at the top; every entry checked in on this form will be assigned to that box.</li>
...
<div class="form-inline bcoem-admin-element hidden-print" style="margin-bottom: 15px;">
	<div class="form-group">
    	<label for="box">Box Number</label>
    	<input type="text" class="form-control" maxlength="5" id="box" name="box" onkeyup="moveOnMax(this,'eid1')" autofocus />
  	</div>
	<span class="help-block" style="display:inline-block; margin: 0 0 0 10px;">Applies to all entries checked in on this screen.</span>
</div>
<?php } ?>
<div class="form-inline">
	...
	<div class="form-group">
    	...
    	<input type="text" class="form-control" maxlength="<?php echo $maxlength; ?>" id="eid<?php echo $i; ?>" name="eid<?php echo $i; ?>" onkeyup="moveOnMax(this,'judgingNumber<?php echo $i; ?>')" <?php if ($i == "1") echo "data-error=\"Field must have a 6 digit number.\" required".(($filter != "box-paid") ? " autofocus" : ""); ?> />
      <?php if ($i == "1") { ?>
