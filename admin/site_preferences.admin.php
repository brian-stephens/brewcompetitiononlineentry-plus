...
<div class="form-group">
    <label for="prefsDisplayScores" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label">Display Scores &amp; Scoresheets</label>
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <div class="input-group">
            <label class="radio-inline">
                <input type="radio" name="prefsDisplayScores" value="Y" id="prefsDisplayScores_0" <?php if (($section != "step3") && (isset($row_prefs['prefsDisplayScores'])) && ($row_prefs['prefsDisplayScores'] == "Y")) echo "CHECKED"; ?> /> Enable
            </label>
            <label class="radio-inline">
                <input type="radio" name="prefsDisplayScores" value="N" id="prefsDisplayScores_1" <?php if (($section == "step3") || (!isset($row_prefs['prefsDisplayScores'])) || ($row_prefs['prefsDisplayScores'] != "Y")) echo "CHECKED"; ?> /> Disable
            </label>
        </div>
        <div class="help-block">Allow logged-in participants to view their personal scores and scoresheets before winner places and public results are released.</div>
    </div>
</div>
<div class="form-group">
...
<?php } ?>
<div class="form-group">
    <label for="prefsCoupons" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label">Vouchers</label>
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <div class="input-group">
            <label class="radio-inline">
                <input type="radio" name="prefsCoupons" value="1" id="prefsCoupons_1" <?php if ((isset($row_prefs['prefsCoupons'])) && ($row_prefs['prefsCoupons'] == "1")) echo "CHECKED"; ?> /> Enable
            </label>
            <label class="radio-inline">
                <input type="radio" name="prefsCoupons" value="0" id="prefsCoupons_0" <?php if ((!isset($row_prefs['prefsCoupons'])) || ($row_prefs['prefsCoupons'] == "0")) echo "CHECKED"; ?> /> Disable
            </label>
        </div>
        <div class="help-block">When enabled, admins can issue voucher codes and participants can redeem them toward entry fees. Existing codes are kept if this is turned off.</div>
    </div>
</div>
