...
<div class="form-group">
    <label for="prefsEvalAdminTools" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label">Eval Admin Tools</label>
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <div class="input-group">
            <label class="radio-inline">
                <input type="radio" name="prefsEvalAdminTools" value="1" id="prefsEvalAdminTools_1" <?php if ((isset($_SESSION['prefsEvalAdminTools'])) && ($_SESSION['prefsEvalAdminTools'] == "1")) echo "CHECKED"; ?> /> Enable
            </label>
            <label class="radio-inline">
                <input type="radio" name="prefsEvalAdminTools" value="0" id="prefsEvalAdminTools_0" <?php if ((!isset($_SESSION['prefsEvalAdminTools'])) || ($_SESSION['prefsEvalAdminTools'] == "0")) echo "CHECKED"; ?> /> Disable
            </label>
        </div>
        <span id="helpBlock" class="help-block">Progress Overview, Entrant Placement Tracker, and Judge Evaluations. Does not turn off electronic scoresheets themselves.</span>
    </div>
</div>
<!-- Modal -->
...
<div class="form-group"><!-- Form Group Radio INLINE -->
    <label for="jPrefsJudgeStats" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 control-label">Track Judge Analytics</label>
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <div class="input-group">
            <!-- Input Here -->
            <label class="radio-inline">
                <input type="radio" name="jPrefsJudgeStats" value="Y" id="jPrefsJudgeStats_0" rel="none" <?php if ((!isset($_SESSION['jPrefsJudgeStats'])) || ($_SESSION['jPrefsJudgeStats'] == "Y")) echo "CHECKED"; ?> /> Yes
            </label>
            <label class="radio-inline">
                <input type="radio" name="jPrefsJudgeStats" value="N" id="jPrefsJudgeStats_1" rel="none" <?php if ((isset($_SESSION['jPrefsJudgeStats'])) && ($_SESSION['jPrefsJudgeStats'] == "N")) echo "CHECKED"; ?>/> No
            </label>
        </div>
        <span id="helpBlock" class="help-block"><p>When enabled, judges see their average words typed and average time spent per entry on their Judging Dashboard, compared to the competition average. Admins get a Judge Analytics report under Scoring. Disabling this stops all tracking of judging time.</p></span>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
        <select class="selectpicker" name="jPrefsMaxBOS" id="jPrefsMaxBOS" data-size="10" data-width="auto">
            <?php for ($i=1; $i <= 3; $i++) { ?>
            <option value="<?php echo $i; ?>" <?php if ((isset($_SESSION['jPrefsMaxBOS'])) && (min((int)$_SESSION['jPrefsMaxBOS'], 3) == $i)) echo "SELECTED"; else { if (!isset($_SESSION['jPrefsMaxBOS']) && $i == 3) echo "SELECTED"; }?>><?php echo $i; ?></option>
            <?php } ?>
        </select>
