...
<?php if ($_SESSION['prefsEval'] == 1) {
    if (($dbTable == "default") && (session_pref_enabled('prefsEvalAdminTools', 1))) {
        echo "<div style=\"margin: 0 0 15px 0;\" class=\"btn-group hidden-print\" role=\"group\"><a class=\"btn btn-block btn-default\" href=\"".$base_url."index.php?section=admin&amp;go=evaluation&amp;action=overview&amp;view=admin\"><span class=\"fa fa-chevron-circle-left\"></span> ".$label_admin.": ".(isset($label_eval_overview) ? $label_eval_overview : $label_evaluations)."</a></div>";
        include (EVALS.'import_scores.eval.php');
    }
    elseif ($dbTable == "default") {
        include (EVALS.'import_scores.eval.php');
    }
}
?>
